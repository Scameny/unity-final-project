...
{ 
    public class DataEditor : OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            tree.AddAllAssetsAtPath("Player Classes", "Assets/Game/Core/Classes", typeof(PlayerClass), true);
            tree.AddAllAssetsAtPath("Enemy Classes", "Assets/Game/Core/EnemiesClasses", typeof(NPCClass), true);
            tree.AddAllAssetsAtPath("Abilities", "Assets/Game/Core/Abilities", typeof(Ability), true)
                .ForEach(this.AddDragHandles);
            tree.AddAllAssetsAtPath("Items", "Assets/Game/Core/Items", typeof(Item), true);
            tree.AddAllAssetsAtPath("PassiveAbilities", "Assets/Game/Core/Abilities", typeof(PassiveAbility), true)
                .ForEach(this.AddDragHandles);
